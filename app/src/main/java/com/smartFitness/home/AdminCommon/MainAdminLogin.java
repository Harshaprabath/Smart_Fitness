                ...
                if (awesomeValidation.validate()) {
                    ...
                    if (emails.indexOf(email) >= 0) {
                        ...
                        Toast.makeText(MainAdminLogin.this, "Admin is not found", Toast.LENGTH_SHORT).show();
                         ...
                         AlertDialog.Builder builder = new AlertDialog.Builder(MainAdminLogin.this);
                         builder.setTitle("Message")
                                .setMessage("If yor are a customer?")
                                .setNeutralButton("NO", null)
                                .setPositiveButton("YES",
                                        new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {
                                                Intent intent = new Intent(MainAdminLogin.this, MainActivity.class);
                                                startActivity(intent);
                                            }
                                        });
